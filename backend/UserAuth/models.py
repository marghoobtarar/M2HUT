...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    cell = models.CharField(max_length=30, blank=True, null=True)
    ...
    trainingInstitute =models.CharField(max_length=30, blank=True, null=True)
    institutePhone = models.CharField(max_length=30, blank=True, null=True)
    facilitatorName = models.CharField(max_length=30, blank=True, null=True)
    institutionAccount = models.CharField(max_length=30, blank=True, null=True)
    instituteAddress = models.CharField(max_length=30, blank=True, null=True)
    instituteCity = models.CharField(max_length=30, blank=True, null=True)
    instituteZip = models.CharField(max_length=30, blank=True, null=True)
    instituteCountry = models.CharField(max_length=30, blank=True, null=True)
    registerName = models.CharField(max_length=30, blank=True, null=True)
